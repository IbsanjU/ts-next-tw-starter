          ...
          <ol className='mt-8 space-y-6'>
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                ...
                <ButtonLink href='https://github.com/ibsanju/ts-next-tw-starter/blob/main/src/styles/colors.css'>
            ...
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <UnstyledLink href='https://revanab.com'>
                  Outside Links
                </UnstyledLink>
              </div>
            </li>
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <PrimaryLink href='https://revanab.com'>
                  Outside Links
                </PrimaryLink>
              </div>
            </li>
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <UnderlineLink href='https://revanab.com'>
                  Outside Links
                </UnderlineLink>
              </div>
            </li>
            ...
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                ...
                <ButtonLink variant='dark' href='https://revanab.com'>
                  Dark Variant
                </ButtonLink>
                <ButtonLink
                  variant='light'
